/*
Adapted from C-PID-Library <https://github.com/mblythe86/C-PID-Library>
...
typedef struct {
  ...
  FloatType myOutput; //   Creates a hard link between the variables and the
  FloatType mySetpoint; //   PID, freeing user from having to constantly tell us
